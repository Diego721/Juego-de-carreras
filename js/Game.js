class Game {
  constructor() {
    this.resetTilte = createElement("h2");
  ...
  addSprites(spriteGroup, numberOfSprites, spriteImage, scale, position = []){
    for(var i = 0; i<numberOfSprites; i++){
     ...
     y = random(-height * 4.8, height-400);
    }
  ...
  handleElements(){
    ...
    this.resetTilte.html("Reiniciar juego");
    this.resetTilte.class("resetText");
    this.resetTilte.position(width/2 + 200, 40);
  ...
  play(){
    ...
    if(allPlayers !== undefined){
      ...
      for(var plr in allPlayers){
        ...
        //guardar el valor de player.life en la variable current life
